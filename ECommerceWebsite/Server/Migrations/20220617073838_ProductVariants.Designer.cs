...
namespace ECommerceWebsite.Server.Migrations
{
    ...
    [Migration("20220617073838_ProductVariants")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceWebsite.Shared.Edition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceWebsite.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("ECommerceWebsite.Shared.ProductVariant", b =>
                {
                    b.HasOne("ECommerceWebsite.Shared.Edition", "Edition")
                        .WithMany()
                        .HasForeignKey("EditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerceWebsite.Shared.Product", "Product")
                        .WithMany("Variants")
            ...
            modelBuilder.Entity("EditionProduct", b =>
                {
                    b.HasOne("ECommerceWebsite.Shared.Edition", null)
                        .WithMany()
                        .HasForeignKey("EditionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerceWebsite.Shared.Product", null)
                        .WithMany()
